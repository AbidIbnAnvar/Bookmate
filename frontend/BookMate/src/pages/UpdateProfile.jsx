						...
						{profilePictures.slice(0, 6).map((profile) => (
							<label key={profile.id} className="flex items-center mx-4">
								...
								<input
									type="radio"
									name="profilePicture"
									className={`radio mx-2 ${selectedProfilePicture === profile.url
										? "text-primary"
										: "text-gray-400"
										}`}
									value={profile.url}
								...
								/>
								<span
									className={`font-poppins font-bold mx-2 ${selectedProfilePicture === profile.url
										? "text-secondary"
										: "text-gray-400"
										}`}
					...
					<div className="w-[350px] flex flex-col items-center mx-auto">
						...
						<div className="form-control my-1">
							<label className="label cursor-pointer flex justify-between">
								...
								<input
									type="checkbox"
									className={`toggle ${instagramPublic ? "toggle-accent" : "toggle-gray"
										}`}
						...
						<div className="form-control my-1">
							<label className="label cursor-pointer flex justify-between">
								...
								<input
									type="checkbox"
									className={`toggle ${phonePublic ? "toggle-accent" : "toggle-gray"
										}`}
									checked={phonePublic}
						...
						<div className="form-control my-1">
							<label className="label cursor-pointer flex justify-between">
								...
								<input
									type="checkbox"
									className={`toggle ${emailPublic ? "toggle-accent" : "toggle-gray"
										}`}
									checked={emailPublic}
